...
import br.com.contmatic.modelo.pessoa.Colaborador;
import br.com.contmatic.modelo.pessoa.TipoContratoTrabalho;
import br.com.six2six.fixturefactory.Fixture;
import br.com.six2six.fixturefactory.Rule;
import br.com.six2six.fixturefactory.loader.TemplateLoader;

public class ColaboradorTemplateFixtureFactory implements TemplateLoader {
    ...
    public void load() {
        ...
        Fixture.of(Colaborador.class).addTemplate("valido", new Rule() {{
            add("pessoa", pessoa);
        ...
        Fixture.of(Colaborador.class).addTemplate("outroValido", new Rule() {{
        ...
        Fixture.of(Colaborador.class).addTemplate("dataInicioContratoQualquer").inherits("valido", new Rule() {{
            add("dataInicioContrato", localDateAleatoria(LocalDate.parse("1900-01-01"), LocalDate.now().plusYears(nextInt(0, 200))));
        }});

        Fixture.of(Colaborador.class).addTemplate("dataInicioContratoFutura").inherits("valido", new Rule() {{
            add("dataInicioContrato", localDateAleatoria(LocalDate.now().plusYears(1), LocalDate.now().plusYears(10)));
        }});

        Fixture.of(Colaborador.class).addTemplate("dataInicioContratoPassada").inherits("valido", new Rule() {{
