...
public class Colaborador {
    ...
    public Colaborador(Pessoa pessoa, TipoContratoTrabalho tipoContratoTrabalho, LocalDate dataInicioContrato) {
        this.pessoa = pessoa;
    ...
    public final boolean equals(Object objeto) {
        ...
        final Colaborador outroColaborador = (Colaborador) objeto;
        return new EqualsBuilder()
                .append(pessoa, outroColaborador.pessoa)
                .isEquals();
    }
